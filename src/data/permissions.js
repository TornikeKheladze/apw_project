export const permissionsObj = {
  ...
  bil_categories_for_applicants: "კატეგორიები აპლიკანტებისთვის",
  bil_services_for_applicants: "სერვისები აპლიკანტებისთვის",
  user_authentication_user: "ავტორიზებული მომხმარებელი",
  user_get_id: "მომხმარებლის წამოღება ID ს მიხედვით",
  user_organisation_id: "ორგანიზაციის წამოღება ID ს მიხედვით",
  user_departments_id: "დეპარტამენტის წამოღება ID ს მიხედვით",
  user_positions_id: "პოზიციის წამოღება ID ს მიხედვით",
  user_create: "მომხმარებლის შექმნა",
  ...
  user_gov_first_step_success:
    "რეგისტრაციის პირველი ეტაპის წარმატებით დასრულება",
  user_gov_first_step_failed:
    "რეგისტრაციის პირველი ეტაპის წარუმატებლად დასრულება",
  user_gov_first_step_comment:
