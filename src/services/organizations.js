...
export const getStatements = (data, page = 1) => {
  return instance.post(`/auth-user/gov-get-auth?page=${page}`, data);
};
...
export const getGovInfo = (data) => {
  return instance.post("/gov-info", data);
};
